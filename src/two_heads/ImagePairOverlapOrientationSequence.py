...
class ImagePairOverlapOrientationSequence(Sequence):
  ...
  def __init__(self, image_path, imgfilenames1, imgfilenames2, dir1, dir2, overlap, orientation,
    ...
    # print("overlap训练数据传入==============", len(self.overlap))
  ...
  def __getitem__(self, idx):
    ...
    # print("network_output_size长度", self.network_output_size)
    ...
    if self.imgfilenames2:  # 走这里
      # print(x1.shape)   # (6, 64, 900, 4)   在xml文件中batch_size :  6
      # print("迭代器内部的train_generator_y_oberlap+++++", y_overlap)
      self.x1 = x1 
      self.x2 = x2 
