...
def demo_infer(config, scan1, scan2):
  ...
  # fig, ax = plt.subplots()
  # depth_data[0][depth_data[0]==-1] = 0 
  # norm = colors.Normalize( 0, 1)

  # depth0 = depth_data[0].astype(np.int32)
  # print(depth0)
  # plt.imshow(depth0,  vmin=0.0, vmax=1.0)
  # plt.show()
  # mytest ===========================================================================

  depth0 = depth_data[0].astype(np.int32)
  depth1 = depth_data[1].astype(np.int32)
  print(depth1)
...
if __name__ == '__main__':
  ...
  network_config['infer_seqs'] = config['Demo2']['infer_seqs']   # 07
